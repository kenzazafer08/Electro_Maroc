...
<div id="productsContainer"class="grid grid-cols-4 gap-y-10 w-full h-auto" >
	...
	<div class="text-xl font-bold text-center m-4 text-purple-900"><?=$product->name?></div>
           ...
           <a href="<?=URLROOT?>/client/Addtocart/<?=$product->id?>" class="w-1/4 px-6 py-2 mb-2 text-md text-white hover:bg-purple-800 hover:text-white text-purple-900 border border-white text-center rounded-xl"><i class="fa fa-shopping-cart"></i></a>
